...
public final class Request
{
     ...
     * @param target
     */
    public Request(zClans plugin, ClanRequest type, List<ClanPlayer> acceptors, ClanPlayer requester, String target, Clan clan, String msg)
    {
        this.type = type;
        this.target = target;
        this.clan = clan;
    ...
    {
        return askCount > zClans.getInstance().getSettingsManager().getMaxAsksPerRequest();
    }
}
