...
public class ClanPlayer implements Serializable, Comparable<ClanPlayer>
{
    ...
    public ClanPlayer(UUID playerUniqueId)
    {
        ...
        Player OnlinePlayer = zClans.getInstance().getServer().getPlayer(playerUniqueId);
        if (OnlinePlayer != null)
        {
            this.displayName = OnlinePlayer.getName();
        } else
        {
            OfflinePlayer OfflinePlayer = zClans.getInstance().getServer().getOfflinePlayer(playerUniqueId);
    ...
    {
        ClanPlayer allycp = zClans.getInstance().getClanManager().getClanPlayer(player);
    ...
    public String getLastSeenDaysString()
    {
        ...
        if (days < 1)
        {
            return zClans.getInstance().getLang("today");
        }
        else if (Math.round(days) == 1)
        {
            return MessageFormat.format(zClans.getInstance().getLang("1.color.day"), ChatColor.GRAY);
        }
        else
        {
            return MessageFormat.format(zClans.getInstance().getLang("many.color.days"), Math.round(days), ChatColor.GRAY);
        }
    }
    ...
    public String getPastClansString(String sep)
    {
        ...
        if (out.trim().isEmpty())
        {
            return zClans.getInstance().getLang("none");
        }
    ...
    public void setBbEnabled(boolean bbEnabled)
    {
        ...
        zClans.getInstance().getStorageManager().updateClanPlayer(this);
    }
    ...
    public void setTagEnabled(boolean tagEnabled)
    {
        ...
        zClans.getInstance().getStorageManager().updateClanPlayer(this);
        zClans.getInstance().getClanManager().updateDisplayName(this.toPlayer());
    }
    ...
    public Player toPlayer()
    {
        ...
        {
            return zClans.getInstance().getServer().getPlayer(this.uniqueId);
        } else
        {
            return zClans.getInstance().getServer().getPlayer(this.displayName);
        }
    }
