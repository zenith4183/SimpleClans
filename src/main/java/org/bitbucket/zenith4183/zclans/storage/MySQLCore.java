package org.bitbucket.zenith4183.zclans.storage;
...
import org.bitbucket.zenith4183.zclans.threads.ThreadUpdateSQL;
...
public class MySQLCore implements DBCore {
    ...
    {
        if (zClans.getInstance().getSettingsManager().getUseThreads())
        {
