...
import org.bitbucket.zenith4183.zclans.commands.*;
...
public final class ClanCommandExecutor implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
    {
        ...
        {
            zClans.getInstance().getServer().getConsoleSender().sendMessage(ChatColor.RED + MessageFormat.format(plugin.getLang("zclans.command.failure"), ex.getMessage()));
