...
import org.bitbucket.zenith4183.zclans.events.RequestEvent;
...
public final class RequestManager
{
    ...
    public void processResults(Request req)
    {
        ...
        zClans.getInstance().getServer().getPluginManager().callEvent(new RequestFinishedEvent(req));
    }
    ...
    public void ask(Request req)
    {
        ...
        zClans.getInstance().getServer().getPluginManager().callEvent(new RequestEvent(req));
    }
}
