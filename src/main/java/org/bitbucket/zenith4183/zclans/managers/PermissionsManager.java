...
public final class PermissionsManager
{
    ...
    {
        zClans.getInstance().getSettingsManager().load();
        permissions.clear();
        for (Clan clan : plugin.getClanManager().getClans())
        {
            permissions.put(clan.getTag(), zClans.getInstance().getConfig().getStringList("permissions." + clan.getTag()));
        }
    }
    ...
    public void savePermissions()
    {
        for (Clan clan : plugin.getClanManager().getClans())
        {
            ...
            {
                zClans.getInstance().getSettingsManager().getConfig().set("permissions." + clan.getTag(), getPermissions(clan));
            }
        }
        zClans.getInstance().getSettingsManager().save();
    }
    ...
    public void addPlayerPermissions(ClanPlayer cp)
    {
        if (cp != null && cp.toPlayer() != null)
        {
            ...
            if (permissions.containsKey(cp.getClan().getTag()))
            {
                ...
                {
                    permAttaches.put(cp.toPlayer(), cp.toPlayer().addAttachment(zClans.getInstance()));
                }
